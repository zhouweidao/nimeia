...
(function($){
  ...
  $(function() {
    ...
    var datascource = {
      ...
      'relationship': '001',
      'children': [
        { 'name': '足球', 'relationship': '110' },
        { 'name': '篮球', 'relationship': '110',
        	'children': [
        	 { 'name': 'NBA', 'relationship': '111' },
        	 { 'name': 'CBA', 'relationship': '111' },
        	 { 'name': '世锦赛', 'relationship': '111' }
        	 
        	]},
        { 'name': '排球', 'relationship': '110' }
      ]
    };
  ...
  setTimeout("$('#rd-edit').trigger('click');",500)
